                        ...
                        <form onSubmit={submitWeaponForm}>
                            ...
                            <div>
                                <div className="form-check form-switch">
                                    ...
                                    <label id="weaponLabel" className="form-check-label"
                                           htmlFor="flexSwitchCheckDefault">Normal
                                        Map</label>
                                </div>
                            ...
                            <div>
                                <label id="weaponLabel" className="col-form-label mt-4" htmlFor="newSkinNameInput">New
                                    Skin
                                    Name</label>
